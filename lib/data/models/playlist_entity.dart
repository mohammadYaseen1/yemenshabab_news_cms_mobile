...
import 'package:yemenshabab/generated/json/playlist_entity.g.dart';

export 'package:yemenshabab/generated/json/playlist_entity.g.dart';
...
class PlaylistItemsSnippet {
  ...
  factory PlaylistItemsSnippet.fromJson(Map<String, dynamic> json) =>
      $PlaylistItemsSnippetFromJson(json);
...
class PlaylistItemsSnippetThumbnails {
  ...
  factory PlaylistItemsSnippetThumbnails.fromJson(Map<String, dynamic> json) =>
      $PlaylistItemsSnippetThumbnailsFromJson(json);
...
class PlaylistItemsSnippetThumbnailsDefault {
  ...
  factory PlaylistItemsSnippetThumbnailsDefault.fromJson(
          Map<String, dynamic> json) =>
      $PlaylistItemsSnippetThumbnailsDefaultFromJson(json);

  Map<String, dynamic> toJson() =>
      $PlaylistItemsSnippetThumbnailsDefaultToJson(this);
...
class PlaylistItemsSnippetThumbnailsMedium {
  ...
  factory PlaylistItemsSnippetThumbnailsMedium.fromJson(
          Map<String, dynamic> json) =>
      $PlaylistItemsSnippetThumbnailsMediumFromJson(json);

  Map<String, dynamic> toJson() =>
      $PlaylistItemsSnippetThumbnailsMediumToJson(this);
...
class PlaylistItemsSnippetThumbnailsHigh {
  ...
  factory PlaylistItemsSnippetThumbnailsHigh.fromJson(
          Map<String, dynamic> json) =>
      $PlaylistItemsSnippetThumbnailsHighFromJson(json);

  Map<String, dynamic> toJson() =>
      $PlaylistItemsSnippetThumbnailsHighToJson(this);
...
class PlaylistItemsSnippetThumbnailsStandard {
  ...
  factory PlaylistItemsSnippetThumbnailsStandard.fromJson(
          Map<String, dynamic> json) =>
      $PlaylistItemsSnippetThumbnailsStandardFromJson(json);

  Map<String, dynamic> toJson() =>
      $PlaylistItemsSnippetThumbnailsStandardToJson(this);
...
class PlaylistItemsSnippetThumbnailsMaxres {
  ...
  factory PlaylistItemsSnippetThumbnailsMaxres.fromJson(
          Map<String, dynamic> json) =>
      $PlaylistItemsSnippetThumbnailsMaxresFromJson(json);

  Map<String, dynamic> toJson() =>
      $PlaylistItemsSnippetThumbnailsMaxresToJson(this);
...
class PlaylistItemsSnippetResourceId {
  ...
  factory PlaylistItemsSnippetResourceId.fromJson(Map<String, dynamic> json) =>
      $PlaylistItemsSnippetResourceIdFromJson(json);
...
class PlaylistItemsContentDetails {
  ...
  factory PlaylistItemsContentDetails.fromJson(Map<String, dynamic> json) =>
      $PlaylistItemsContentDetailsFromJson(json);
...
class PlaylistItemsStatus {
  ...
  factory PlaylistItemsStatus.fromJson(Map<String, dynamic> json) =>
      $PlaylistItemsStatusFromJson(json);
...
class PlaylistPageInfo {
  ...
  factory PlaylistPageInfo.fromJson(Map<String, dynamic> json) =>
      $PlaylistPageInfoFromJson(json);
